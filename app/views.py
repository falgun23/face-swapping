...
# 	img = cv2.imread("/home/falcon/Documents/Python practice/College Project/Face_Swapping/face_images/23.jpeg")
# 	img_gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
# 	mask = np.zeros_like(img_gray)
...
# 	detector = dlib.get_frontal_face_detector()
# 	predictor = dlib.shape_predictor("/home/falcon/Documents/Python practice/College Project/Face_Swapping/shape_predictor_68_face_landmarks.dat")
...
# fs = realtime_face_swapping.FACESWAPPING(seamlessclone)
